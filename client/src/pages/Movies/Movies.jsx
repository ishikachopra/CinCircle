...
export default function CineCircleLandingPage() {
    ...
    return (
        <div className="bg-black text-white h-[80vh] md:h-screen relative mt-16 lg:mt-0">
            

            {/* Hero Section */}
            <div className="relative w-full">
                <motion.div
                    className="relative w-full h-[80vh] md:h-screen bg-cover bg-center bg-fixed flex flex-col justify-center "
                    style={{
                ...
                >
                    ...
                    <div className="bg-black bg-opacity-60 w-auto h-full px-3 md:px-16 lg:px-20 ">
                        <motion.div
                            className="w-full md:w-1/2 mt-24  text-left lg:mt-56 lg:mb-24 md:mt-36 mb-16 "
                            initial={{ x: -50, opacity: 0 }}
                            animate={{ x: 0, opacity: 1 }}
                            transition={{ duration: 0.6 }}
                        >
                            <h2 className="text-2xl md:text-4xl lg:text-6xl font-extrabold mb-4">
