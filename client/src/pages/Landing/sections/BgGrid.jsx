...
const GridBackground = () => {
    ...
    return (
        <>
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-tr from-purple-950 via-black to-black overflow-hidden bg-opacity-0">
